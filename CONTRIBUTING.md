...
Commit `site/` and push to `main`. Vercel deploys it automatically to https://openwiki-delta.vercel.app/openwiki/. Photos are generated with `scripts/generate_images.py` (Gemini) and the share card with `scripts/build_og.py`.
